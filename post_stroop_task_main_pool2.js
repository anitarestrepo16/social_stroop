...
var practice_words = [
    ...
    { stimulus: `<p style='font-size: 37.333px; font-family: Arial, Helvetica, sans-serif;
     color: rrgb(23, 5, 250);'><strong>RED</strong></p>`, correct_response: 'b', word: 'red', color: 'blue', category: 'social_pos'},
    { stimulus: `<p style='font-size: 37.333px; font-family: Arial, Helvetica, sans-serif;
...
var test_procedure = {
    ...
    timeline_variables: jsPsych.randomization.shuffle(words_pool2) /* randomize the order of appearance of words */
}
